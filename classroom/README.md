...
| 📊 **Dashboard / Дүн** | Эрх авсан багш өөрийн тойм (анги/сурагч/шалгалт/дүн) + шалгалт бүрийн дундаж оноог харна |
| 🔄 **Офлайн синк** | Интернэтгүй үед scan хийсэн дүн алдагдахгүй — дараалалд хадгалагдаж, холбогдоход Google Sheets рүү автоматаар синк хийгдэнэ |
...
│   ├── sync/                   # Офлайн → онлайн синк
│   │   ├── outbox.js           # Хүлээгдэж буй бичилтийн дараалал (localStorage)
│   │   ├── sync.js             # Синк хөдөлгүүр (онлайн болоход автомат)
│   │   └── useSync.js          # Синк төлвийн React hook
│   ├── components/
...
Анги дотор **интернэтгүй** байсан ч scan хийсэн дүн **алдагдахгүй**:

1. Офлайн үед уншуулсан дүн **дараалалд (outbox)** localStorage-д тогтвортой хадгалагдана.
2. Толгой дээрх заагч **"Офлайн · N"** эсвэл **"Синк (N)"** гэж хүлээгдэж буй тоог харуулна.
   Дүнгийн жагсаалтад тэдгээр нь **⏳ синк хүлээж буй** тэмдэгтэйгээр шууд харагдана.
3. Интернэт **холбогдмогц автоматаар** (мөн 30 сек тутамд, эсвэл заагч дээр дарж гараар)
   Google Sheets рүү синк хийгдэнэ. Амжилттай синк хийгдсэн мөр серверийн жагсаалтад орно.

Түүнчлэн бүх **GET** хүсэлт (анги, сурагч, шалгалт, дүн) сүүлийн утгаа localStorage-д кэшлэдэг тул
нэг удаа онлайнаар ачаалсны дараа **офлайн үед ч** хуудсууд нээгдэж, scan хийх боломжтой.

> Энэ нь зөвхөн **бодик горимд** (`VITE_USE_API=true`, Netlify/Vercel) хамаатай. Demo горимд бүх
> дата аль хэдийн локалд хадгалагддаг тул синк шаардлагагүй.

Код: [`src/sync/outbox.js`](src/sync/outbox.js) (дараалал),
[`src/sync/sync.js`](src/sync/sync.js) (синк хөдөлгүүр),
[`src/components/SyncBadge.jsx`](src/components/SyncBadge.jsx) (заагч).
